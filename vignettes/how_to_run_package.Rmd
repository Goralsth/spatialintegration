...
seurat_merge<-merge_seurat_objects(seurat_object = seurat_object, Allen_SEA_AD_Atlas)
...
```{r}
p<-RankPlot(seurat_merge)

ggsave(p,"rank_plot_nmfrank15.png")
```
...
FeaturePlot(seurat_merge, features = paste0("NMF_", c(6,15)), raster = FALSE)
...
GSEAHeatmap(seurat_merge, reduction = "nmf", max.terms.per.factor = 500)
